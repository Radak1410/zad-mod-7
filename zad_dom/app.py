...
with st.sidebar:
    ...
    pie = st.checkbox('Wykresy kołowe')
...
if pie:
    fig = px.pie(same_cluster_df.sort_values("age"), names="age")    
else:
...
if pie:
    fig = px.pie(same_cluster_df, names="edu_level")
else:
...
if pie:
    fig = px.pie(same_cluster_df, names="fav_animals") 
else:
...
if pie:
    fig = px.pie(same_cluster_df, names="fav_place")
else:
...
if pie:
    fig = px.pie(same_cluster_df, names="gender")
else:
